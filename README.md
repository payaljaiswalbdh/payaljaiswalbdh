...
Computer Science undergraduate skilled in full stack, along with exposure to machine learning. Comfortably working with Pandas, Node.js, Express, and
...
|---------|------------|--------|
| **StudySphere - Academic Workflow Platform** | MERN, Tailwind CSS, JWT | ✅ Completed |
| **🎵 Spotify Clone** | Node.js, Express.js, MongoDB, JWT Authentication, RESTful API Development | ✅ Completed | 
